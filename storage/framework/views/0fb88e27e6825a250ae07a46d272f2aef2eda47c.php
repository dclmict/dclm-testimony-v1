...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/dlcmbrand.css')); ?>">
...
<body class="container-fluid">
    <div class="row <?php echo e(request()->routeIs('home')?'d-none':''); ?> d-md-flex">
        <div class="col-md-6  main-side d-flex flex-column justify-content-center align-items-center ">
            ...
            <img class="icon img-fluid" width="500" src="<?php echo e(asset('images/icon.png')); ?>" alt="">
            <?php if(!request()->routeIs('thanks')): ?>
                <img width="200" class="img-fluid" src="<?php echo e($active_crusade->banner); ?>" alt="">
            <?php endif; ?>
        </div>
    ...
    <div class="row d-md-none">
        <div class="col-md-12 main-side-mobile">
            ...
            <div class="d-flex flex-column align-items-center justify-content-center" style="margin-top:25vh">
                <div>
                    <h1 class="text-center" style="font-size: 20px; color:whitesmoke"> <?php echo e($active_crusade->name); ?>
                ...
                <img class="icon img-fluid" style="opacity: 0.3" width="500" src="<?php echo e(asset('images/icon.png')); ?>"
                    alt="">

                <div class="mt-5">

                    <a href="<?php echo e(route('testimony.show')); ?>" class="btn main-button mb-5">Share My Testimony</a>
...
<?php /**PATH /home/jonathan/LaravelProjects/dclm-testimony/resources/views/layouts/main.blade.php ENDPATH**/ ?>